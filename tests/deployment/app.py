...
MODEL_V2_PATH = os.getenv("MODEL_CANARY_PATH", "src/models/canary")
MOVIES_FILE = os.getenv("MOVIES_FILE", "data/raw_data/movies.csv")

#external canaray config path
CANARY_CONFIG_PATH = os.getenv(
    "CANARY_CONFIG_PATH",
    os.path.join(os.path.dirname(__file__), "config", "canary_config.json")
)

DEFAULT_CANARY_PERCENTAGE = float(os.getenv("CANARY_PERCENTAGE", "20"))
...
CANARY_PERCENTAGE = float(os.getenv("CANARY_PERCENTAGE", "20"))
